...
message_text = "🎁 <b>Вам активирована бонусная подписка на 5 дней!</b>\n\n\
Чтобы защищать трафик и смотреть контент без блокировок, подключите VPN прямо сейчас, используя кнопку ниже."
